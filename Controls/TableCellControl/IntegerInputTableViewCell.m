...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier title: title lowerLimit:(NSInteger)lower hightLimit:(NSInteger)upper selectedValue:(NSInteger)value
{
