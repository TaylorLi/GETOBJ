...
- (void) initData{
    @try {
        ...
        if(userInfo.measureFormat == MEASURE_UNIT_METRIC){
            [backgroundImage setImage:[UIImage imageNamed:@"Target_bg_metric"]];
        }else{
            [backgroundImage setImage:[UIImage imageNamed:@"Target_bg_enghlish.png"]];
        }
        ...
        lblDistanceTarget.text = [NSString stringWithFormat:@"%.2f", targetDistance];
        ...
        UIImage *stepImage = [[UIImage imageNamed:@"Target_bar.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,45,0,45)];
        UIImage *caloriesImage = [[UIImage imageNamed:@"Target_bar.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,58,0,58)];
        UIImage *distanceImage = [[UIImage imageNamed:@"Target_bar.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0,58,0,58)];
        imgVStep.frame = CGRectMake(69, 119, [self percentOfTarget:target.targetStep withRemain:target.remainStep], 18);
        imgVStep.image = stepImage;
        imgVCalories.frame = CGRectMake(69, 300, [self percentOfTarget:target.targetCalorie withRemain:target.remainCalorie], 18);
        imgVCalories.image = caloriesImage;
        imgVDistance.frame = CGRectMake(69, 210, [self percentOfTarget:targetDistance withRemain:remainDistance], 18);
