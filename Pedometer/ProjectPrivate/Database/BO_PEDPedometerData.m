...
{
    return [self queryObjectBySql:@"select * from PEDPedometerData where targetId = ? order by optDate LIMIT 1" parameters:[[NSArray alloc] initWithObjects:targetId, nil]];
}
