...
- (NSString *) tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section {
    JMStaticContentTableViewSection *sectionContent = [self.staticContentSections objectAtIndex:section];
	return sectionContent.footerText;
}
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(cellContent.configureBlock!=nil)
...
- (void) addSection:(JMStaticContentTableViewControllerAddSectionBlock)b andHeader:(NSString*) header andFooter:(NSString *)footer{
...
- (void) addSection:(JMStaticContentTableViewControllerAddSectionBlock)b {
	[self addSection:b andHeader:nil andFooter:nil];
}
