...
{
	return [str stringFromMD5];
}
+ (NSString *) encryptStr:(NSString *) str key:(NSString *)_key
{
	return [SecretHelper doCipher:str key:_key context:kCCEncrypt];
}
+ (NSString *) decryptStr:(NSString	*) str key:(NSString *)_key
{
	return [SecretHelper doCipher:str key:_key context:kCCDecrypt];
}
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt) {    
        dTextIn = [[SecretHelper decodeBase64WithString:sTextIn] mutableCopy];    
    }    
    else{    
    ...
    if (encryptOrDecrypt == kCCDecrypt){    
        ...
        sResult = [SecretHelper encodeBase64WithData:dResult];    
    }           
    return sResult;
}
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
	return [SecretHelper encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
